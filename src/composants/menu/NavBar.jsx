    ...
    return (
        <nav className={`nav_bar  ${ouvert ? "voir_menu" : "cacher_menu"}`}>
            ...
            <ul className="nav_liste">
                <li><Link to='/' className="nav_lien">Accueil</Link></li>
                <li><Link to='/produit' className="nav_lien">Produits</Link></li>
                <li><Link to='#' className="nav_lien">Services</Link></li>
                <li><Link to='#' className="nav_lien">Contact</Link></li>
            </ul>
        </nav>
    )
}